...
window.MareLocale = (() => {
  const translations = {
    ...
    "Available": ["Verfügbar", "Disponibile", "Disponible"],
    "Please choose only available dates.": ["Bitte wählen Sie nur verfügbare Daten.", "Scegli solo date disponibili.", "Veuillez choisir uniquement des dates disponibles."],
    "Drag from arrival to departure, or select the two dates. Only available dates can be selected.": ["Ziehen Sie vom Anreise- zum Abreisedatum oder wählen Sie beide Daten aus. Nur verfügbare Daten sind wählbar.", "Trascina dalla data di arrivo alla partenza, oppure seleziona le due date. Puoi selezionare solo date disponibili.", "Faites glisser de la date d’arrivée à la date de départ, ou sélectionnez les deux dates. Seules les dates disponibles peuvent être sélectionnées."],
