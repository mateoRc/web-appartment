...
- The terrace leads the page. The six-photo gallery includes the kitchen, living room, both bedrooms, beach view and hallway last. It uses a compact desktop grid and a swipeable mobile row with arrows and a counter. Three upscaled historical images appear separately in the heritage section, served from `assets`; originals remain in `historical`.
